    ...
    while True:
        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            if len(lista_notas)>0:
                ...
                #Agregar codigo
                resultado=nota.buscar(id)
                if resultado:
                    print(f"{"id":<10} {"Titulo":<15} {"Descripcion":<20} {"Fecha":<15}")
                    for fila in resultado:
                        print(f"{fila[0]:<10} {fila[2]:<15} {fila[3]:<15} {fila[4]}")
                else:
                    print(f"No fue posible buscar la nota en este momento, intente denuevo mas tarde")
                funciones.esperarTecla()    
            else:
                print("No hay notas para este usuario")
